...
//		JPanel contentPnl = (JPanel) getContentPane();		//get the original content panel from the window
		JPanel contentPnl = new JPanel();					//create a new panel, set it as the content panel of the window
		setContentPane(contentPnl);
		//2.layout:a way to orginaze(BorderLayout)
		contentPnl.setLayout(null);//absolute/no layout
